...
if (!dir.exists(paste0("~", "/my_files/fitness"))) {
  dir.create(paste0("~", "/my_files/fitness"))
}

if (!dir.exists(paste0("~", "/my_files/fitness/calendar"))) {
  dir.create(paste0("~", "/my_files/fitness/calendar"))
}

if (!dir.exists(paste0("~", "/my_files/fitness/backups"))) {
  dir.create(paste0("~", "/my_files/fitness/backups"))
}

if (!file.exists(paste0("~", "/my_files/fitness/data.csv")) & 
    !file.exists(paste0("~", "/my_files/fitness/run.csv")) &
    !file.exists(paste0("~", "/my_files/fitness/plan.csv")) &
    !file.exists(paste0("~", "/my_files/fitness/calendar.csv"))) {
  ##### create csv files
  write.table(data.frame("No", "Date", "Workout", "Duration"),
              file = paste0("~", "/my_files/fitness/data.csv"),
              row.names = FALSE,
              col.names = FALSE,
              sep = ",",
              quote = FALSE)
  ...
  write.table(data.frame("No", "Date", "Distance", "Duration", "Pace"),
              file = paste0("~", "/my_files/fitness/run.csv"),
              row.names = FALSE,
              col.names = FALSE,
              sep = ",",
              quote = FALSE)
  ...
  write.table(data.frame("id", "content", "start"),
              file = paste0("~", "/my_files/fitness/plan.csv"),
              row.names = FALSE,
              col.names = FALSE,
              sep = ",",
              quote = FALSE)
  ...
  write.table(data.frame("starttime", "summary"),
              file = paste0("~", "/my_files/fitness/calendar/calendar.csv"),
              row.names = FALSE,
              col.names = FALSE,
              sep = ",",
              quote = FALSE)
...
if (!file.exists(paste0("~", "/my_files/fitness/calendar/template_header.ics")) & 
    !file.exists(paste0("~", "/my_files/fitness/calendar/template_body.ics")) &
    !file.exists(paste0("~", "/my_files/fitness/calendar/template_footer.ics"))) {
  
  cat("BEGIN:VCALENDAR\nVERSION:2.0\nCALSCALE:GREGORIAN",
      file = paste0("~", "/my_files/fitness/calendar/template_header.ics"))
  cat("BEGIN:VEVENT\nDTSTART:20060912T060000Z\nUID:461092315540@example.com\nSUMMARY:new2\nEND:VEVENT\n",
      file = paste0("~", "/my_files/fitness/calendar/template_body.ics"))
  cat("END:VCALENDAR",
      file = paste0("~", "/my_files/fitness/calendar/template_footer.ics"))
  
}

setwd(paste0("~", "/my_files/fitness"))

path <- paste0("~", "/my_files/fitness/data.csv")

run <- paste0("~", "/my_files/fitness/run.csv")

plan <- paste0("~", "/my_files/fitness/plan.csv")

calendar <- paste0("~", "/my_files/fitness/calendar/calendar.csv")
...
server <- function(input, output, session) {
  ...
  observeEvent(input$backup, {
    ...
    withProgress(message = "Backing up data...", {
      system("cp ~/my_files/fitness/data.csv ~/my_files/fitness/backups/data_backup.csv")
      system("cp ~/my_files/fitness/run.csv ~/my_files/fitness/backups/run_backup.csv")
      system("cp ~/my_files/fitness/plan.csv ~/my_files/fitness/backups/plan_backup.csv")
      system("cp ~/my_files/fitness/calendar/calendar.csv ~/my_files/fitness/backups/calendar_backup.csv")
    }) # withProgress
  ...
  observeEvent(input$calendar_sync, {
    ...
    df <- read.csv(paste0("~", "/my_files/fitness/calendar/calendar.csv"),
                   sep = "\t",
                   stringsAsFactors = FALSE)
    
    ics_header <- readLines(paste0("~", "/my_files/fitness/calendar/template_header.ics"), warn = FALSE)
    ics_body <- readLines(paste0("~", "/my_files/fitness/calendar/template_body.ics"), warn = FALSE)
    ics_footer <- readLines(paste0("~", "/my_files/fitness/calendar/template_footer.ics"), warn = FALSE)
    ics_events <- ""
    ...
    write(ics_events, file = paste0("~", "/my_files/fitness/calendar/Workouts.ics"))
    
    system("open ~/my_files/fitness/calendar/Workouts.ics")
  })
